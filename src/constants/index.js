 ...
 * 注册 邮箱/电话
 */
export const REQUEST_REGISTER_WITH_EMAIL=new Request("REQUEST_REGISTER_WITH_EMAIL")
export const REQUEST_REGISTER_WITH_PHONE=new Request("REQUEST_REGISTER_WITH_PHONE")
